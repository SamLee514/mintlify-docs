...
2. A diagnostic job starts processing your data, and a link to the live job run will be provided.
3. You'll see real-time progress as the job runs, both on the job page and in the ongoing CLI session.
...
<Frame>
  ![Example Ghost Flight Report](/issue.png)
</Frame>
